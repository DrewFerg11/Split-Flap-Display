...
| SANXIXING ESP32-S3 44-pin (DevKitC-1 clone) | `S3 44-PIN`    | ESP32-S3-WROOM-1 N16R8 | 16 MB / 8 MB octal |  44  | 2× USB-C  | not yet supported — [Part 2](plans/ESP-BOARDS-PART-2-PLAN.md) | [B0DB1WK3CW](https://www.amazon.com/dp/B0DB1WK3CW) |
...
<details>
<summary>Chip vs. module vs. board — three layers, only one of them stable</summary>
...
<details>
<summary>Three memories, and why only two of them are in the env name</summary>
