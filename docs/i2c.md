...
**Fix:** Confirm 4.7kΩ pull-ups are installed on SDA and SCL on one board in the chain. See the [custom PCB page](module-boards/custom-pcb/dowjames-v5.1/index.md#1-add-i2c-pull-up-resistors) for placement guidance.
