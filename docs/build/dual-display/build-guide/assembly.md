...
<table style="border-collapse: collapse; text-align: center; width: 100%;">
  <thead>
    <tr>
      <th style="padding: 0.4rem 0.5rem; text-align: left;">← Back view</th>
      <th style="padding: 0.4rem 0.5rem;">8</th>
      <th style="padding: 0.4rem 0.5rem;">7</th>
      <th style="padding: 0.4rem 0.5rem;">6</th>
      <th style="padding: 0.4rem 0.5rem;">5</th>
      <th style="padding: 0.4rem 0.5rem;">4</th>
      <th style="padding: 0.4rem 0.5rem;">3</th>
      <th style="padding: 0.4rem 0.5rem;">2</th>
      <th style="padding: 0.4rem 0.5rem;">1</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="padding: 0.4rem 0.5rem; text-align: left; font-weight: bold;">Row 1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
    ...
    <tr>
      <td style="padding: 0.4rem 0.5rem; text-align: left; font-weight: bold;">Row 2</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444; font-weight: bold; background: #b45309; color: #fff;">D.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444; font-weight: bold; background: #b45309; color: #fff;">D.1</td>
      <td style="padding: 0.4rem 0.5rem; border: 1px solid #444;">A.1</td>
