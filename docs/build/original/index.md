...
<figure markdown>
![Split-flap display showing OKAY — original rounded enclosure](../../assets/display/37-flap-main.png)
</figure>
...
|---|---|---|---|
| Original | 37 | ![Original rounded enclosure](../../assets/display/37-flap.png){ width="160" } | [MakerWorld](https://makerworld.com/en/models/1116618#profileId-1114192) |
| Square | 37 | ![Square enclosure](../../assets/display/37-flap-square.jpg){ width="160" } | [MakerWorld](https://makerworld.com/en/models/2489058-split-flap-display-square-enclosure#profileId-2734898) |
| Extended | 48 | ![Extended charset](../../assets/display/48-flap.png){ width="160" } | [MakerWorld](https://makerworld.com/en/models/1296793-split-flap-display-extended-charset-48-flaps#profileId-1328346) |
